...
/**
We have a list of over 30,000 USA ci0es and their popula0ons. It would be helpful if the data could be sorted in different
and helpful ways to answer important ques0ons. Some sample queries: “What are the most populous ci0es in USA?” or
“What are the most populous ci0es in a chosen state?” or “What states in the USA have a city named Springfield?”
In this project, you will create a database from the list of USA ci0es and sort the data. You will sort the data for
popula0on and city name using Selec0on Sort, Inser0on Sort, and Merge Sort.
 *
